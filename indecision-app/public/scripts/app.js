...
var Person = function () {
  ...
  _createClass(Person, [{
    ...
    value: function getDescription() {
      if (this.age) return this.name + ' is ' + this.age + ' year(s) old!';else return 'Ops, we don\'t know ' + this.name + ' age!';
    }
  }]);
...
var meStudent = new Student('Felipão', 24, undefined);
console.log(meStudent.getGreeting());
console.log(meStudent.getDescription());

var meTraveler = new Traveler('Felipão', 24, 'New York, NY');
